...
This ARC illustrates way of achieving this behaviour, without the need of smart contracts. This is why it is considered an extension of [ARC-69](https://arc.algorand.foundation/ARCs/arc-0069). For much more complex SBT implementations, please refer to [ARC-20](https://github.com/algorandfoundation/ARCs/pull/119).
...
For a token to be described as Soulbound, it must meet the following criteria:
